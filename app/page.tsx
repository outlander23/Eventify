          ...
          <div className="container-app">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-primary hover:bg-primary-variant text-primary-foreground" asChild>
                  <Link href="/events">
                    Browse Events
                ...
                <Card key={i} className="card-elevated hover:shadow-lg transition-page cursor-pointer group">
                  ...
                  <CardContent className="p-6 space-y-4">
                    <div className="flex items-start justify-between">
                      ...
                      <span className="text-small text-success font-medium">{event.price}</span>
                    </div>
                    ...
                    <div className="flex gap-2 pt-2">
                      <Button className="flex-1 bg-primary hover:bg-primary-variant" asChild>
